...
<head>
    ...
    <title>GrainRise | Retailer • Basic Information</title>
            ...
            <div class="mt-12 flex-1 overflow-y-auto pr-1 sm:pr-2
                ...
                <div class="pt-0 sm:pt-1 text-center">
                    ...
                    <h1 class="mt-3 text-2xl sm:text-[30px]
                        ...
                        Create Account <span class="text-yellow-500">(Retailer)</span>
                    </h1>
                ...
                <form class="mt-6 sm:mt-7 space-y-4" action="#" method="POST" novalidate>
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="text" value="Retailer" readonly
                    ...
                    <div class="space-y-4">
                     ...
                     <!-- Continue -->
                    <a href="{{ route('signup.verify', ['role' => 'retailer']) }}"
