...
<head>
    ...
    <title>GrainRise | Warehouse Manager • Basic Information</title>
            ...
            <div class="mt-12 flex-1 overflow-y-auto pr-1 sm:pr-2
                ...
                <div class="pt-0 sm:pt-1 text-center">
                    ...
                    <h1 class="mt-3 text-2xl sm:text-[30px]
                        ...
                        Create Account <span class="text-yellow-500">(Manager)</span>
                    </h1>
                ...
                <form class="mt-6 sm:mt-7 space-y-4" action="#" method="POST" novalidate>
                    ...
                    <input type="hidden" name="role" value="warehouse">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="text" value="Warehouse Manager" readonly
                    ...
                    <div class="space-y-4">
                     ...
                     <!-- Continue -->
                    <a href="{{ route('signup.verify', ['role' => 'warehouse']) }}"
...
<script>
    ...
    (function () {
        ...
        function setBadge(ok) {
            ...
            lenBadge.classList.toggle('text-green-900/70', !ok);
            lenBadge.classList.toggle('text-green-900', ok);
            lenBadge.classList.toggle('ring-black/5', !ok);
            lenBadge.classList.toggle('ring-green-900/20', ok);
            lenBadge.classList.toggle('bg-white/80', !ok);
            lenBadge.classList.toggle('bg-emerald-50', ok);

            lenBadge.textContent = ok
                ? '✓ Minimum 8 characters'
                : '• Minimum 8 characters';
        }
